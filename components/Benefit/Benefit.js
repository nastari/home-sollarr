...
import back from '~/public/back3.jpeg';
            ...
            <Grid item md={5}>
              <div className={classes.desc}>
                ...
                <ul className={classes.list}>
                  <li>Serão 4 lançamentos onde os investidores podem comprar o token SLLC.</li>
                  <li>Após isso será possível adquirir a mercado em exchanges.</li>
                  <li>O valor do token sobe a cada lançamento.</li>
                  <li>O token está atrelado aos rendimentos das Usinas SollarCoin.</li>
                </ul>
              </div>
            </Grid>
            <Grid item md={7}>
              <div>
                {/* <figure className={classes.img}>
                  <img src={imgAPI.crypto[4]} alt="benefit" />
                </figure> */}
              </div>
              <Hidden mdDown>
